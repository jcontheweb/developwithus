...
.footer-link {
  @apply transition duration-300 block;
...
.social {
  @apply inline-flex items-center justify-center leading-none rounded-full border border-indigo-100 p-1 transition duration-300;
  height: 36px;
  width: 36px;
}
</style>